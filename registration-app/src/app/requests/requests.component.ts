...
// For Edit registration, you can implement a method to navigate to the edit form
  editRegistration(id: string | undefined) {
    if (!id) return;
    // Navigate to the edit form with the registration id
    // This can be done using Angular Router, e.g.:
    // this.router.navigate(['/edit-registration', id]);
